function Footer() {
  return (
    <footer className="text-center text-lg-start bg-body-tertiary text-muted mt-5 pt-2">
      <section className="text-decoration-none">
        <div className="container text-center text-md-start mt-5">
          <div className="row mt-3 text-decoration-none">
            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 p-2">
              <a>
      ...
      >
        © 2025 Copyright:&nbsp;
        <a className="text-reset fw-bold" href="https://zerodha.com/">
          Zerodha.com
        </a>
      </div>
    </footer>
